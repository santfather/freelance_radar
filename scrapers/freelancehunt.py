...
URLS = [
    "https://freelancehunt.pl/projects",
    "https://freelancehunt.pl/projects?category=web-programming",
    "https://freelancehunt.pl/projects?category=mobile-apps",
]
BASE = "https://freelancehunt.pl"
        ...
        for url in URLS:
            ...
            for card in cards:
                title_el = (
                    ...
                    or card.select_one("a.project-title")
                ...
                date_el = card.find("time") or card.select_one(".date, .posted")
