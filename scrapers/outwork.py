...
URLS = [
    "https://outwork.pl/offers",
    "https://outwork.pl/offers?category=it",
    "https://outwork.pl/offers?category=web",
]
BASE = "https://outwork.pl"


class OutworkScraper(BaseScraper):
    source_name = "outwork"
    ...
    async def scrape(self) -> list[Job]:
        ...
        for url in URLS:
            ...
            for card in cards:
                title_el = (
                    card.select_one("a[href*='/offer']")
                    or card.select_one("a[href*='/offers/']")
                ...
                date_el = card.find("time") or card.select_one(".date, .created-at")
